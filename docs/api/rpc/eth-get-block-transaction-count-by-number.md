# eth_getBlockTransactionCountByNumber | Mavis Docs
...
## Request[​](/api/rpc/eth-get-block-transaction-count-by-number#request "Direct link to Request")
...
## Responses[​](/api/rpc/eth-get-block-transaction-count-by-number#responses "Direct link to Responses")
...
```
curl -L 'https://api-gateway.skymavis.com/rpc/' \-H 'Content-Type: application/json' \-H 'Accept: application/json' \-d '{  "id": 1,  "jsonrpc": "2.0",  "method": "eth_getBlockTransactionCountByNumber",  "params": [    "0x23969b3"  ]}'
```
...
{
  "id": 1,  "jsonrpc": "2.0",  "method": "eth\_getBlockTransactionCountByNumber",  "params": \[    "0x23969b3"  \]
}
Send API Request
