...
## Request[​](/api/rpc/eth-block-number#request "Direct link to Request")
...
## Responses[​](/api/rpc/eth-block-number#responses "Direct link to Responses")
...
```
{  "jsonrpc": "2.0",  "id": 1,  "result": "0x2396cc0"}
```
...
```
curl -L 'https://api-gateway.skymavis.com/rpc/' \-H 'Content-Type: application/json' \-H 'Accept: application/json' \-d '{  "id": 1,  "jsonrpc": "2.0",  "method": "eth_blockNumber"}'
```
...
{
  "id": 1,  "jsonrpc": "2.0",  "method": "eth\_blockNumber"
}
Send API Request
