...
-   `transactions`: an array of transaction objects. For details, see [`eth_getTransactionByHash`](/api/rpc/eth-get-transaction-by-hash).
-   `uncles`: an array of uncle hashes.

## Request[​](/api/rpc/eth-get-block-by-hash#request "Direct link to Request")
...
## Responses[​](/api/rpc/eth-get-block-by-hash#responses "Direct link to Responses")
...
```
curl -L 'https://api-gateway.skymavis.com/rpc/' \-H 'Content-Type: application/json' \-H 'Accept: application/json' \-d '{  "id": 1,  "jsonrpc": "2.0",  "method": "eth_getBlockByHash",  "params": [    "0x8b06d51723142d2df2dac7808c0cb9bcb38c4a7ecf9519ca1eabb4d26a469057",    false  ]}'
```
...
{
  "id": 1,  "jsonrpc": "2.0",  "method": "eth\_getBlockByHash",  "params": \[    "0x8b06d51723142d2df2dac7808c0cb9bcb38c4a7ecf9519ca1eabb4d26a469057",    false  \]
}
Send API Request
