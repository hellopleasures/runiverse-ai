...
## Request[​](/api/rpc/eth-chain-id#request "Direct link to Request")
...
## Responses[​](/api/rpc/eth-chain-id#responses "Direct link to Responses")
...
```
curl -L 'https://api-gateway.skymavis.com/rpc/' \-H 'Content-Type: application/json' \-H 'Accept: application/json' \-d '{  "id": 1,  "jsonrpc": "2.0",  "method": "eth_chainId"}'
```
...
{
  "id": 1,  "jsonrpc": "2.0",  "method": "eth\_chainId"
}
Send API Request
