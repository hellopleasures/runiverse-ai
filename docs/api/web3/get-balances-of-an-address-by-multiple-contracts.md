# Get balances of an address by multiple contracts | Mavis Docs
...
-   [Skynet Web3 API](/api/web3/skynet-web-3-api)
    ...
    -   [Accounts](/api/web3/get-balances-of-an-address-by-multiple-contracts)
    ...
    -   [Blocks](/api/web3/get-balances-of-an-address-by-multiple-contracts)
        
    -   [Logs](/api/web3/get-balances-of-an-address-by-multiple-contracts)
        
    -   [Collections](/api/web3/get-balances-of-an-address-by-multiple-contracts)
        
    -   [Contracts](/api/web3/get-balances-of-an-address-by-multiple-contracts)
        
    -   [Transactions](/api/web3/get-balances-of-an-address-by-multiple-contracts)
        
    -   [Token transfers](/api/web3/get-balances-of-an-address-by-multiple-contracts)
        
    -   [NFTs](/api/web3/get-balances-of-an-address-by-multiple-contracts)
...
## https://api-gateway.skymavis.com/skynet/ronin/web3/v2/accounts/:address/contracts

Get balances of an address by multiple contracts

## Request[​](/api/web3/get-balances-of-an-address-by-multiple-contracts#request "Direct link to Request")
...
## Responses[​](/api/web3/get-balances-of-an-address-by-multiple-contracts#responses "Direct link to Responses")
...
```
{  "result": {    "items": [      {        "contractAddress": "string",        "name": "string",        "symbol": "string",        "standard": "string",        "balance": "string",        "decimals": 0,        "tokenCount": 0,        "metadata": {}      }    ]  }}
```
...
```
curl -L 'https://api-gateway.skymavis.com/skynet/ronin/web3/v2/accounts/:address/contracts' \-H 'Content-Type: application/json' \-H 'Accept: application/json' \-H 'X-API-KEY: <API_KEY_VALUE>' \-d '{  "contractAddresses": [    "string"  ]}'
```
