# Get collection detail | Mavis Docs
...
-   [Skynet Web3 API](/api/web3/skynet-web-3-api)
    ...
    -   [Accounts](/api/web3/get-collection-detail)
        
    -   [Blocks](/api/web3/get-collection-detail)
        
    -   [Logs](/api/web3/get-collection-detail)
        
    -   [Collections](/api/web3/get-collection-detail)
    ...
    -   [Contracts](/api/web3/get-collection-detail)
        
    -   [Transactions](/api/web3/get-collection-detail)
        
    -   [Token transfers](/api/web3/get-collection-detail)
        
    -   [NFTs](/api/web3/get-collection-detail)
...
## https://api-gateway.skymavis.com/skynet/ronin/web3/v2/collections/:contractAddress

Get collection detail

## Request[​](/api/web3/get-collection-detail#request "Direct link to Request")
...
## Responses[​](/api/web3/get-collection-detail#responses "Direct link to Responses")
...
```
{  "result": {    "contractAddress": "string",    "name": "string",    "symbol": "string",    "standard": "string",    "totalSupply": "string",    "totalOwners": 0,    "totalTransfers": 0,    "metadata": {}  }}
```
...
```
curl -L 'https://api-gateway.skymavis.com/skynet/ronin/web3/v2/collections/:contractAddress' \-H 'Accept: application/json' \-H 'X-API-KEY: <API_KEY_VALUE>'
```
