# Get detail of an NFT | Mavis Docs
...
-   [Skynet Web3 API](/api/web3/skynet-web-3-api)
    ...
    -   [Accounts](/api/web3/get-detail-of-an-nft)
        
    -   [Blocks](/api/web3/get-detail-of-an-nft)
        
    -   [Logs](/api/web3/get-detail-of-an-nft)
        
    -   [Collections](/api/web3/get-detail-of-an-nft)
    ...
    -   [Contracts](/api/web3/get-detail-of-an-nft)
        
    -   [Transactions](/api/web3/get-detail-of-an-nft)
        
    -   [Token transfers](/api/web3/get-detail-of-an-nft)
        
    -   [NFTs](/api/web3/get-detail-of-an-nft)
...
This API endpoint will be deprecated by the end of Q1 2025 as part of Skynet sunsetting. Please migrate to the Moralis alternative: [Get NFT metadata](https://docs.moralis.com/web3-data-api/evm/reference/get-nft-metadata)

GET 

## https://api-gateway.skymavis.com/skynet/ronin/web3/v2/collections/:contractAddress/tokens/:tokenId

For usage instructions, see [Get NFTs details](https://docs.skymavis.com/ronin/skynet/guides/get-nfts-details)

## Request[​](/api/web3/get-detail-of-an-nft#request "Direct link to Request")
...
## Responses[​](/api/web3/get-detail-of-an-nft#responses "Direct link to Responses")
...
```
{  "result": {    "tokenId": "string",    "contractAddress": "string",    "name": "string",    "symbol": "string",    "standard": "string",    "tokenUri": "string",    "metadata": {}  }}
```
...
```
curl -L 'https://api-gateway.skymavis.com/skynet/ronin/web3/v2/collections/:contractAddress/tokens/:tokenId' \-H 'Accept: application/json' \-H 'X-API-KEY: <API_KEY_VALUE>'
```
