# Get token transfers of an NFT | Mavis Docs
...
-   [Skynet Web3 API](/api/web3/skynet-web-3-api)
    ...
    -   [Accounts](/api/web3/get-token-transfers-of-an-nft)
        
    -   [Blocks](/api/web3/get-token-transfers-of-an-nft)
        
    -   [Logs](/api/web3/get-token-transfers-of-an-nft)
        
    -   [Collections](/api/web3/get-token-transfers-of-an-nft)
    ...
    -   [Contracts](/api/web3/get-token-transfers-of-an-nft)
        
    -   [Transactions](/api/web3/get-token-transfers-of-an-nft)
        
    -   [Token transfers](/api/web3/get-token-transfers-of-an-nft)
        
    -   [NFTs](/api/web3/get-token-transfers-of-an-nft)
...
This API endpoint will be deprecated by the end of Q1 2025 as part of Skynet sunsetting. Please migrate to the Moralis alternative: [Get NFT transfers by token ID](https://docs.moralis.com/web3-data-api/evm/reference/get-nft-transfers)

GET 

## https://api-gateway.skymavis.com/skynet/ronin/web3/v2/collections/:contractAddress/tokens/:tokenId/transfers

For usage instructions, see [Get all token transfers of an NFT](https://docs.skymavis.com/ronin/skynet/guides/get-all-token-transfers-of-an-nft)

## Request[​](/api/web3/get-token-transfers-of-an-nft#request "Direct link to Request")
...
## Responses[​](/api/web3/get-token-transfers-of-an-nft#responses "Direct link to Responses")
...
```
curl -L 'https://api-gateway.skymavis.com/skynet/ronin/web3/v2/collections/:contractAddress/tokens/:tokenId/transfers' \-H 'Accept: application/json' \-H 'X-API-KEY: <API_KEY_VALUE>'
```
